...
function bindKeyboard(MyComponent) {
  ...
  function (_React$Component) {
    ...
    function BindKeyboard() {
      ...
      return (0, _possibleConstructorReturn2.default)(_this, (_temp = _this = (0, _possibleConstructorReturn2.default)(this, (_ref = BindKeyboard.__proto__ || Object.getPrototypeOf(BindKeyboard)).call.apply(_ref, [this].concat(args))), _this.state = {}, _this.handleKeyDown = function (event) {
        var action;
    ...
    (0, _createClass2.default)(BindKeyboard, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            other = (0, _objectWithoutProperties2.default)(_props, ["index", "onChangeIndex"]);
